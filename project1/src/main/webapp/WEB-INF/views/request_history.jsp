    ...
    <aside class="sidebar">
        ...
        <div>
            ...
            <nav class="menu">
                ...
                <a href="#"><i class="fa-solid fa-triangle-exclamation"></i> Emergency Request</a>
        ...
        <div class="table-card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Fatima Begum</td>
                        <td><span class="blood">AB-</span></td>
                        <td>Care Hospital</td>
                        <td>Mumbai</td>
